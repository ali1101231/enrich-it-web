    ...
    <div className="min-h-screen bg-background flex">
        ...
        >
          ...
          >
            ...
            <p className="text-primary-foreground/70 text-lg max-w-md mx-auto">
              Join thousands of sales teams using Koldify to find and enrich leads.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="mt-12 glass rounded-xl p-5 max-w-xs mx-auto border border-primary-foreground/10"
          >
            <div className="flex items-center gap-3 text-sm text-primary-foreground/80">
              <div className="w-8 h-8 rounded-full bg-primary-foreground/20 flex items-center justify-center text-xs font-bold text-primary-foreground">JD</div>
              <div className="text-left">
                <div className="font-medium text-primary-foreground">Jane Doe</div>
                <div className="text-xs text-primary-foreground/50">VP Sales · Acme Corp</div>
              </div>
              <span className="ml-auto text-xs text-emerald-300 font-semibold">✓ Verified</span>
            </div>
          </motion.div>
        </motion.div>
      </motion.div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        ...
        >
          ...
          >
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight mb-2">Create your account</h1>
